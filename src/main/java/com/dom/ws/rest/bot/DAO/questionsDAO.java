   ...
   // private static final String SQL_DELETE = "DELETE FROM dommapi.questions WHERE idWhatsapp = ?";
    ...
    public boolean create(questionsDTO dto) {
        ...
        try {
            ...
            log.log(Level.SEVERE, "Connection pool timeout or error in questionsDAO create: {0}", ex);
            return false;
        }
    }
    ...
    public boolean update(questionsDTO dto) {
        ...
        try {
            ...
            log.log(Level.SEVERE, "Connection pool timeout or error in questionsDAO update: {0}", ex);
            return false;
        }
    }
    ...
    public questionsDTO readOne(questionsDTO dto) {
        ...
        try {
            ...
            log.log(Level.SEVERE, "Connection pool timeout or error in questionsDAO readOne: {0}", ex);
            questionsDTO errorDto = new questionsDTO();
    ...
    public List<questionsDTO> readMany(questionsDTO dto) {
        ...
        try {
            ...
            log.log(Level.SEVERE, "Connection pool timeout or error in questionsDAO readMany: {0}", ex);
            questionsDTO errorDto = new questionsDTO();
            msgError errorMsg = new msgError();
            errorMsg.setCode(-1);
            errorMsg.setMessage("Connection pool timeout: " + ex.getMessage());
